...
def parse_dataset_args(parser):
    ...
    parser.add_argument("--cf_index_file", type=str, default="", help="collaborative code index file suffix")
    parser.add_argument("--sem_index_file", type=str, default="", help="semantic code index file suffix")
    parser.add_argument("--item_id_base", type=int, default=1,
                        help="base of item ids in inter data; teacher/source embeddings are assumed pad-free")
...
def parse_train_args(parser):
    ...
    parser.add_argument("--encoder_input_mode", type=str, default="code", choices=["code", "item_id"])
    parser.add_argument("--cf_teacher_emb_path", type=str, default="")
    parser.add_argument("--sem_teacher_emb_path", type=str, default="")
    parser.add_argument("--scheduler_type", type=str, default="inverse_sqrt", choices=["inverse_sqrt", "constant"])
    parser.add_argument("--warmup_updates", type=int, default=2000)
    ...
    parser.add_argument("--aux_num_layers", type=int, default=1)
    return parser
