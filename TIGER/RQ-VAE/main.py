...
def parse_args():
    ...
    parser.add_argument('--kmeans_iters', type=int, default=100, help='max kmeans iterations for initialization')
    parser.add_argument('--sk_epsilons', type=float, nargs='+', default=[0.0, 0.0, 0.003], help='sinkhorn epsilons for 3 RQ layers')
    parser.add_argument('--sk_iters', type=int, default=50, help='max sinkhorn iterations')
    parser.add_argument('--layers', type=int, nargs='+', default=[2048, 1024, 512, 256], help='hidden sizes of every layer')
